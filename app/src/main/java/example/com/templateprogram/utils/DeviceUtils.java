...
//        System.out.println("UUID----->" + uuid.toString());
    ...
    public static List<String> getUserIMEI() {
        ...
        if (Build.VERSION.SDK_INT >= 21) {//5.0以后
            String imei1 = getDeviced(MyApp.getApplication(), 0);//第一个插槽
            String imei2 = getDeviced(MyApp.getApplication(), 1);//第二个插槽
            if (StringUtils.isBlank(imei1) && StringUtils.isBlank(imei2)) {
                String imei3 = getimei(MyApp.getApplication());
            ...
            String imei1 = getimei(MyApp.getApplication());
    ...
    public static List<String> getUserIMSI() {
        List<String> list = new ArrayList<>();
        if (Build.VERSION.SDK_INT >= 21) {//5.0以后
            String sim1 = getSubscriberId(MyApp.getApplication(), getSubId(MyApp.getApplication(), 0));//第一个插槽
            String sim2 = getSubscriberId(MyApp.getApplication(), getSubId(MyApp.getApplication(), 1));//第二个插槽
            ...
            if (StringUtils.isBlank(sim1) && StringUtils.isBlank(sim2)) {
                String sim3 = getimsi(MyApp.getApplication());
                if (!StringUtils.isBlank(sim3)) {
                    list.add(sim3);
                }
            }
        } else {
            String sim1 = getimsi(MyApp.getApplication());
            if (!StringUtils.isBlank(sim1)) {
                list.add(sim1);
            }
        }
    ...
    public static String getUniqueDeviceID(Context context) {
        ...
        try {
            ...
            filePath1 = MyApp.getApplication().getFilesDir() + File.separator + "SADeviceID" + File.separator + "7e8e9e123456.txt";
