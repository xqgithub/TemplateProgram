...
public class TestPicassoActivity extends BaseActivity implements View.OnClickListener {
    ...
    private String url = "http://192.168.123.178:8080/two.jpg";
    private ImageView iv_picasso;
    private String dir = MyApp.getApplication().getFilesDir() + File.separator + "SAcceleratorad";//图片缓存路径

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        iv_picasso = (ImageView) findViewById(R.id.iv_picasso);
        initPicasso(TestPicassoActivity.this);
...
//        loadPicFromFile();
    ...
    public Picasso initPicasso(Context mcontext) {
