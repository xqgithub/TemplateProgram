...
import example.com.templateprogram.test.activity.TestAPIEncryptActivity;
import example.com.templateprogram.test.activity.TestAlarmManagerActivity;
...
import example.com.templateprogram.test.activity.TestDagger2Activity;
...
import example.com.templateprogram.test.activity.TestMeituanSelectCityActivity;
...
import example.com.templateprogram.test.activity.TestSortingAlgorithmActivity;
import example.com.templateprogram.test.activity.TestThreadPoolActivity;
...
//                    LogUtils.i("position---->短点击" + position);
                    if (position == 0) {
                        ...
                        StaticStateUtils.intentToJump(mContext, TestMarqueeTextViewActivity.class, Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    } else if (position == 40) {
                        StaticStateUtils.intentToJump(mContext, TestAlarmManagerActivity.class, Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    } else if (position == 41) {
                        StaticStateUtils.intentToJump(mContext, TestDagger2Activity.class, Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    } else if (position == 42) {
                        StaticStateUtils.intentToJump(mContext, TestRXJAVAActivity.class, Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    } else if (position == 43) {
                        StaticStateUtils.intentToJump(mContext, TestConstraintLayoutActivity.class, Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    } else if (position == 44) {
